...
<html>
    <head>
        <meta charset="utf-8">
        <title>Dean - Alumni Affairs & Institutional Relations - NIT Agartala</title>
    ...
    <body>
            ...
            <main id="administration-page">
                <div class="container pad-v-2">
                    <h1 class="position-relative">
                        <span class="b-b-theme-thick">Alumni Affairs & Institutional Relations</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-9">
                            <ul class="no-bullet no-mar no-pad space-li-1">
                                <li>
                                    <span class="text-bold">Dr. Prasun Chakraborty</span><br />
                                    Dean (Alumni Affairs & Institutional Relations)<br />
                                    Contact: 0381 2546630 (O)
                                </li>
                                <li>
                                    <span class="text-bold">Shri Kunal Chakma</span><br />
                                    Associate Dean (Alumni Affairs & Institutional Relations)<br />
                                    Contact: 0381 2546630 (O)
                                </li>
                            </ul>
                        </div>
        ...
        <script>
            $(document).ready(function() {
                $("#nav-administration, .nav-left-alumni-affairs").addClass("active");
            });
        </script>
    </body>
</html>
