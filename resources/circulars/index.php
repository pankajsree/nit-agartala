    ...
    <body>
        <?= $nav ?>
            <main id="resources-page">
                <div class="container">
                    <h1><span class="b-b-theme-thick">Circulars</span></h1>
                    <div class="row">
                        <div class="col-12">
                            <ul class='no-pad no-mar menu-left a-no-underline no-bullet line-h-2'>
                                ...
                                <div class="collapse expand-init" id="collapseAbout">
                                    <ul class="no-pad list-style-none">
                                        <li class="menu-left-sub"><a href="<?= __ROOT__ ?>/docs/circulars/xxxxxxxxxxxxxx.pdf" target="_blank">The Institute</a></li>
                                        <li class="menu-left-sub"><a href="<?= __ROOT__ ?>/docs/circulars/xxxxxxxxxxxxxx.pdf" target="_blank">History</a></li>
                                        <li class="menu-left-sub"><a href="<?= __ROOT__ ?>/docs/circulars/xxxxxxxxxxxxxx.pdf" target="_blank">Director</a></li>
                                        <li class="menu-left-sub"><a href="<?= __ROOT__ ?>/docs/circulars/xxxxxxxxxxxxxx.pdf" target="_blank">Facilities</a></li>
                                    </ul>
                                </div>
