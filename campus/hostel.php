    ...
    <body>
            ...
            <main>
                <div class="container">
                    <h1 class="position-relative">
                        <span class="b-b-theme-thick">Hostel</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-9">
                            <p>The students actively participate in all co-curricular activities like games and sports, techno-cultural festival, essay competition, drama competition, rallies on various themes, NSS programmes etc. sponsored by the State Government, Central Government and other statutory bodies and the institute authority. N.S.S or N.C.C. is a compulsory subject for all students of first year.</p>
                        </div>
                    </div>
                </div>
            </main>
        ...
        <script>
            $(document).ready(function() {
                $("#nav-campus, .sub-nav-hostel").addClass("active");
            });
        </script>
    </body>
</html>
